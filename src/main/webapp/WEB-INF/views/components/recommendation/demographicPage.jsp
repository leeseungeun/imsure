            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 input-area">
                <input type="text"
                  ...
                  id="user" ng-model="inName" maxlength="12"
            ...
            <div class="form-group">
              ...
              <ul class="col-sm-10 sex two-option-radio">
                <li class="custom-li-left"><input type="radio"
                  id="male" name="gender" value="남자"> <label
                  for="male">남자</label></li>
                <li class="custom-li-right"><input type="radio"
                  id="female" name="gender" value="여자"> <label
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 input-area">
                <input type="text"
                  ...
                  id="birth-d" ng-model="inAge" maxlength="8"
                  placeholder="예) 1990212" ng-blur="ageCheck()">
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <ul class="col-sm-10 recommend-chk two-option-radio">
                  <li class="custom-li-left"><input type="radio"
                    id="married" name="marry" value="기혼"> <label
                    for="married">기혼</label></li>
                  <li class="custom-li-right"><input type="radio"
                    id="single" name="marry" value="미혼"> <label
              ...
              <div class="form-group">
                ...
                <ul class="col-sm-10 recommend-chk two-option-radio">
                  <li class="custom-li-left"><input type="radio"
                    id="child-has" name="child" value="유"> <label
                    for="child-has">유</label></li>
                  <li class="custom-li-right"><input type="radio"
                    id="child-none" name="child" value="무"> <label
                    for="child-none">무</label></li>
                </ul>
                <p class="notice is-pl notice-under-ul" id="childNotice">
                  <small> 자녀가 성인인 경우는 '무'를 선택해주세요.<br>
                  </small>
                </p>
              </div>
              <!-- 결혼무 선택했을 경우 보여줘야함-->
              <div class="form-group">
                <label class="control-label col-sm-2">부양가족 </label>
                <ul class="col-sm-10 recommend-chk two-option-radio">
                  <li class="custom-li-left"><input type="radio"
                    id="fam-has" name="family" value="유"> <label
                    for="fam-has">유</label></li>
                  <li class="custom-li-right"><input type="radio"
                    id="fam-none" name="family" value="무"> <label
                    for="fam-none">무</label></li>
                </ul>
              </div>
            </div>
          </form>
        ...
        <div class="form-area step2">
          <form
            ...
            <div class="form-group">
              ...
              <ul class="col-sm-10 recommend-chk two-option-radio">
                <li class="custom-li-left"><input type="radio"
                  id="cancer-has" name="cancer" value="유"> <label
                  for="cancer-has">유</label></li>
                <li class="custom-li-right"><input type="radio"
                  id="cancer-none" name="cancer" value="무"> <label
            ...
            <div class="form-group" style="margin-bottom: 2%">
              ...
              <div class="col-sm-8 input-area" id="salary-input-wrapper">
                <input type="text"
                  class="form-control onlyNumber ng-pristine ng-untouched ng-valid ng-not-empty ng-valid-maxlength"
                  id="salary" ng-model="inSalary" maxlength="4"
            ...
            <div class="form-group type-height">
              ...
              <ul class="jobs col-sm-10">
                ...
                <li class="custom-li-left">
                  <input type="radio" id="serviceWorker" name="joblist" value="근로소득자"> 
                ...
                <li class="custom-li-left">
                  <input type="radio" id="labor" name="joblist" value="근로소득자">
                  <label for="labor">단순노무 종사자</label>
                </li>
                <li class="custom-li-left">
                  <input type="radio" id="housewife" name="joblist" value="근로소득자">
                  <label for="housewife">주부</label>
                </li>
                <li class="custom-li-left">
                  <input type="radio" id="etc" name="joblist" value="근로소득자">
          ...
          <div class="btn-block btn-input">
            ...
            <button class="btn btn-search" ng-click="sendSugarResult()"
              ng-readonly="next2Checek()"
              ng-attr-title="{{next2buttonTitle}}" title="">내게 맞는 보험 찾기</button>
          </div>
        </div>
      </div>
    </div>
